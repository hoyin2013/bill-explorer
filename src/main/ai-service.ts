...
3. 商品品名、单位、数量、单价、日期等字段：识别不清、模糊、无法辨认的内容直接赋值 null，不要脑补猜测文字和数字；**唯独 name（客户人名）例外——必须填充，模糊时从【已知客户人名清单】中选取最相似的人名，禁止置 null**
...
3. 商品品名、单位、数量、单价、日期等字段：识别不清、模糊、无法辨认的内容直接赋值 null，不要脑补；**唯独 name（客户人名）例外——必须填充，模糊时从【已知客户人名清单】中选取最相似的人名，禁止置 null**
4. 一张小票对应数组内一个对象
5. 数字类字段只输出纯数字，不要带 元、个 等文字符号
